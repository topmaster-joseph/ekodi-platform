...
export const SITE_DEFINITIONS = Object.freeze(EKODI_SERVICES.filter(service => service.operational !== false).map(service => (
  [service.id, service.name, service.domain, service.url]
)));
