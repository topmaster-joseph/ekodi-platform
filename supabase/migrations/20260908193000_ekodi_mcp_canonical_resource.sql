...
comment on function public.ekodi_mcp_access_token_hook(jsonb) is
  'For OAuth tokens, forces role=anon. Active consent plus an approved canonical or legacy EKODI MCP resource request emits only the canonical https://ekodi.kr/mcp audience and ekodi_ai_client=true.';
