...
-- 2026-09-26 (Sat) 15:00-17:00, preserving any applications submitted under the former key.
...
-- No public API has used the new key before this migration. If a row was
-- manually created under the new key, keep it and discard only the duplicate
-- old-key application for the same normalized phone.
