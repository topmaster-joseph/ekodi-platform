...
function baseStyle(){
  ...
  *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:var(--sand);color:var(--ink);word-break:keep-all;overflow-wrap:break-word}a{color:inherit}
  ...
  @media(max-width:680px){.site-header{position:sticky;top:0;z-index:20}.site-header__inner{min-height:58px;gap:8px;width:calc(100% - 20px)}.site-brand{min-width:0}.site-brand__text{font-size:16px}.site-nav{min-width:0;gap:2px}.site-nav a{padding:0 9px;font-size:12px}.site-nav a:nth-child(2),.site-nav a:nth-child(3){display:none}main{width:min(100% - 20px,1120px);padding-top:12px}.hero{padding:22px 18px;border-radius:20px}.hero:after{right:-108px;bottom:-120px;transform:scale(.72)}.hero h1{font-size:38px}.hero .lead{font-size:16px;line-height:1.65}.hero-actions{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.hero-actions a{width:100%;justify-content:center;padding:0 10px}.section{margin-top:22px}.section-head{align-items:flex-start;flex-direction:column;margin-bottom:10px}.section h2{font-size:22px}.section-note{font-size:13px}.intent-strip{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.intent-strip a{min-height:50px;padding:8px;font-size:13px}.grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.card{min-height:124px;padding:13px;border-radius:16px}.card strong{font-size:16px}.card span{font-size:12px}.personal{grid-template-columns:1fr;gap:8px}.personal__main,.personal__aside{padding:17px;border-radius:18px}.button{min-height:46px}.button-light{width:100%}.talk{grid-template-columns:1fr;padding:17px}.talk .button{width:100%}.org{align-items:stretch;flex-direction:column;padding:16px}.org .button{width:100%}.access-form{grid-template-columns:1fr}.access-form .wide{grid-column:auto}th:nth-child(3),td:nth-child(3){display:none}}
  @media(max-width:390px){.site-nav a:not(.site-nav__my){display:none}.site-nav__my{min-height:42px}.grid{grid-template-columns:repeat(2,minmax(0,1fr))}.card{min-height:120px;padding:12px}.hero{padding:20px 16px}.hero h1{font-size:36px}}
  </style>`;
}
