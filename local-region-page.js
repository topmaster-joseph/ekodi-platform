...
function baseStyle(){
  ...
  *{box-sizing:border-box}html{scroll-behavior:smooth;max-width:100%;overflow-x:hidden}body{margin:0;max-width:100%;background:var(--sand);color:var(--ink);word-break:keep-all;overflow-wrap:break-word;overflow-x:hidden}img,svg,video,canvas{max-width:100%;height:auto}a{color:inherit}
  ...
  @media(max-width:680px){.site-header,.site-header__inner,main,.local-page,.section,.hero,.personal,.talk,.org{max-width:100%}.site-header__inner{width:calc(100% - 24px);min-height:58px;gap:8px}.site-brand__text{font-size:16px}.site-nav a{padding:0 9px;font-size:12px}.site-nav a:nth-child(2),.site-nav a:nth-child(3){display:none}main{width:calc(100% - 24px);margin-left:auto;margin-right:auto;padding-top:14px}.hero{padding:24px 20px;border-radius:22px}.hero h1{font-size:40px}.hero .lead{font-size:16px;line-height:1.65}.section{margin-top:24px}.section-head{width:100%;align-items:flex-start;flex-direction:column}.section-head>*{min-width:0;max-width:100%}.grid{width:100%;grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.card{min-height:132px;padding:14px;border-radius:16px}.card strong{font-size:16px}.talk{width:100%;grid-template-columns:minmax(0,1fr)}.talk .button{width:100%}.org{align-items:flex-start;flex-direction:column}.access-form{grid-template-columns:1fr}.access-form .wide{grid-column:auto}th:nth-child(3),td:nth-child(3){display:none}}
  @media(max-width:390px){.site-header__inner{width:calc(100% - 20px)}main{width:calc(100% - 20px)}.site-nav a:not(.site-nav__my){display:none}.grid{grid-template-columns:1fr 1fr}.card{min-height:126px}.hero-actions a{flex:1 1 calc(50% - 8px);justify-content:center}}
  </style>`;
}
