...
async function bundledShell(request,env){
  ...
  const [shellResponse,navResponse,contextResponse,userHeaderResponse,adminShellResponse,headerResponse,messageResponse,illustrationResponse,designInheritanceResponse,linkCompatResponse]=await Promise.all([
