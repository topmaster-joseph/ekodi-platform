...
async function bundledShell(request,env){
  ...
  const [shellResponse,navResponse,contextResponse,userHeaderResponse,userFooterResponse,adminShellResponse,headerResponse,messageResponse,illustrationResponse,designInheritanceResponse,linkCompatResponse]=await Promise.all([
  ...
  headers.set('x-ekodi-user-ui-footer',userFooter?'v1':'missing');
