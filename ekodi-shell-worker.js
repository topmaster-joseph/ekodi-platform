...
async function bundledShell(request,env){
  ...
  const [shellResponse,navResponse,contextResponse,headerResponse,messageResponse,linkCompatResponse]=await Promise.all([
