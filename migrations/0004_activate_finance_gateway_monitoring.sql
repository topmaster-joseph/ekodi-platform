...
VALUES
  ...
  ('trade','active',1,'정식 주소: ekodi.kr/ekodibiz/trade',CURRENT_TIMESTAMP);
...
UPDATE service_controls
SET state='active', monitor_enabled=1, note='정식 주소: ekodi.kr/ekodibiz/trade', updated_at=CURRENT_TIMESTAMP
