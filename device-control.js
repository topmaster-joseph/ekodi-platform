...
const COMMAND_POLICIES = Object.freeze({
  ...
  'printing.image_preview.status': { risk: 'observe' },
  'printing.image_preview.repair': { risk: 'maintain', confirm: true },
  'printing.image_preview.restore': { risk: 'maintain', confirm: true },
...
const COMMAND_CAPABILITIES = Object.freeze({
  ...
  'printing.image_preview.status': 'imagePrintPreview',
  'printing.image_preview.repair': 'imagePrintPreview',
  'printing.image_preview.restore': 'imagePrintPreview',
...
function summarizeCommandResult(result = {}) {
  ...
  if (result.desktopUiCanary && typeof result.desktopUiCanary === 'object') {
    summary.desktopUiCanary = {
      ok: result.desktopUiCanary.ok === true,
      mode: safeText(result.desktopUiCanary.mode, 100),
      provider: safeText(result.desktopUiCanary.provider, 100),
      routingPolicy: safeText(result.desktopUiCanary.routingPolicy, 100),
      backendPolicy: safeText(result.desktopUiCanary.backendPolicy, 120),
      agentVersion: safeText(result.desktopUiCanary.agentVersion, 40),
      guestAgentVersion: safeText(result.desktopUiCanary.guestAgentVersion, 40),
      backend: safeText(result.desktopUiCanary.backend, 80),
      sessionType: safeText(result.desktopUiCanary.sessionType, 40),
      sessionId: safeText(result.desktopUiCanary.sessionId, 80),
      taskId: safeText(result.desktopUiCanary.taskId, 80),
      taskType: safeText(result.desktopUiCanary.taskType, 80),
      receiptSha256: safeText(result.desktopUiCanary.receiptSha256, 80),
      executedAsSystem: result.desktopUiCanary.executedAsSystem === true,
      noNetworkAdapter: result.desktopUiCanary.noNetworkAdapter === true,
      noActiveNetwork: result.desktopUiCanary.noActiveNetwork === true,
      guestUiSurfaceUsed: result.desktopUiCanary.guestUiSurfaceUsed === true,
      hostInteractiveDesktopUsed: result.desktopUiCanary.hostInteractiveDesktopUsed === true,
      sharedInteractiveDesktop: result.desktopUiCanary.sharedInteractiveDesktop === true,
      semanticUiAutomation: result.desktopUiCanary.semanticUiAutomation === true,
      lowLevelInputInjection: result.desktopUiCanary.lowLevelInputInjection === true,
      clipboardShared: result.desktopUiCanary.clipboardShared === true,
      credentialCollection: result.desktopUiCanary.credentialCollection === true,
      hostProfileMounted: result.desktopUiCanary.hostProfileMounted === true,
      syntheticUiOnly: result.desktopUiCanary.syntheticUiOnly === true,
      windowHandleObserved: result.desktopUiCanary.windowHandleObserved === true,
      windowFound: result.desktopUiCanary.windowFound === true,
      buttonFound: result.desktopUiCanary.buttonFound === true,
      invokePatternAvailable: result.desktopUiCanary.invokePatternAvailable === true,
      controlInvoked: result.desktopUiCanary.controlInvoked === true,
      resultCode: safeText(result.desktopUiCanary.resultCode, 80),
      windowClosed: result.desktopUiCanary.windowClosed === true,
      mutationScope: safeText(result.desktopUiCanary.mutationScope, 80),
      vmReachedRunning: result.desktopUiCanary.vmReachedRunning === true,
      heartbeatObserved: result.desktopUiCanary.heartbeatObserved === true,
      networkAttached: result.desktopUiCanary.networkAttached === true,
      ephemeralDifferencingDisk: result.desktopUiCanary.ephemeralDifferencingDisk === true,
      baseDiskWriteForbidden: result.desktopUiCanary.baseDiskWriteForbidden === true,
      sessionVmRemoved: result.desktopUiCanary.sessionVmRemoved === true,
      sessionDiskRemoved: result.desktopUiCanary.sessionDiskRemoved === true,
      checkedAt: safeText(result.desktopUiCanary.checkedAt, 64),
    };
  }
