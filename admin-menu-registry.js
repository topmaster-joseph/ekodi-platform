...
export const ADMIN_MENU_GROUPS = Object.freeze([
  ...
  { id: 'executors', icon: '▶', defaultSection: 'executor-registry', labels: { ko: '실행기', en: 'Executors' } },
...
export const ADMIN_MENU_REGISTRY = Object.freeze([
  ...
  { id: 'executor-registry', group: 'executors', icon: '▶', delegateSection: 'devices', labels: { ko: '실행기 목록', en: 'Executor Registry' }, governance: { track: 'agent', changeClass: 'yellow', authorityContext: 'Person + Workspace + Role + Capability', controlPlane: true, globalPolicyMutation: 'super_admin' } },
  { id: 'executor-infrastructure', group: 'executors', icon: 'D', delegateSection: 'devices', labels: { ko: '실행 인프라', en: 'Execution Infrastructure' } },
  { id: 'executor-jobs', group: 'executors', icon: 'W', delegateSection: 'work', labels: { ko: '실행 작업', en: 'Execution Jobs' } },
  { id: 'executor-verification', group: 'executors', icon: '✓', delegateSection: 'aiops', labels: { ko: '검증·증거', en: 'Verification & Evidence' } },
  { id: 'executor-policies', group: 'executors', icon: '⚙', delegateSection: 'ai-settings', labels: { ko: '배정·대체 정책', en: 'Routing & Fallback Policies' }, superAdminOnly: true },
...
const ADMIN_MENU_SECTION_CATEGORY = Object.freeze({
  ...
  'executor-registry':'executors','executor-infrastructure':'executors','executor-jobs':'executors','executor-verification':'executors','executor-policies':'executors',
