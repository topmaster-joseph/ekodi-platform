...
export const ADMIN_MENU_REGISTRY = Object.freeze([
  ...
  { id: 'aiops', group: 'system', icon: 'AI', labels: { ko: 'AI 운영센터', en: 'AI Operations Center' }, governance: { track: 'agent', changeClass: 'yellow', authorityContext: 'Person + Workspace + Role + Capability', controlPlane: true, globalPolicyMutation: 'super_admin' } },
  { id: 'openai', group: 'system', icon: 'O', labels: { ko: 'OpenAI 작업공간', en: 'OpenAI Workspace' }, providerWorkspace: true },
