...
export const ADMIN_MENU_REGISTRY = Object.freeze([
  ...
  { id: 'social', group: 'services', icon: 'S', labels: { ko: '소셜', en: 'Social' }, internal: true },
  { id: 'aiops', group: 'ai', icon: 'AI', labels: { ko: '운영 AI', en: 'AI Operations' } },
  { id: 'marketing-ai', group: 'ai', icon: 'M', labels: { ko: '마케팅 운영', en: 'Marketing Operations' } },
...
export function getAdminMenuGroupDefault(id) {
  const group = getAdminMenuGroup(id); if (!group) return 'campus';
