export const ADMIN_MENU_GROUPS = Object.freeze([
  { id: 'site-management', labels: { ko: '사이트', en: 'Sites' } },
...
export const ADMIN_MENU_REGISTRY = Object.freeze([
  { id: 'campus', group: 'site-management', icon: '▦', labels: { ko: '사이트 관리', en: 'Site Management' } },
  ...
  { id: 'clients', group: 'site-management', icon: 'C', labels: { ko: '고객 사이트', en: 'Customer Sites' } },
