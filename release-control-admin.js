(() => {
  ...
  const MALL_FREE_OPS_URL = 'https://ekodi.kr/ekodibiz/ekodimall/free-ops?embed=admin';
  const DEPLOYMENTS_SECTION = 'deployments';
  const RELEASE_UNITS = [
    { id:'shared-site', name:'Shared Site · Admin/Auth', workflow:'deploy-admin-site.yml', model:'Candidate 0% → verify → 100%', risk:'high', domains:['ekodi.kr','admin.ekodi.kr'] },
  ...
  function installMallFreeOpsNav() {
    ...
    if (!section) {
      ...
      external.href = 'https://ekodi.kr/ekodibiz/ekodimall/free-ops';
