(() => {
  ...
  const MALL_FREE_OPS_URL = 'https://ekodi.kr/ekodimall/free-ops?embed=admin';
  ...
  const RELEASE_UNITS = [
    ...
    { id:'finance-api', name:'Finance API', workflow:'deploy-finance.yml', model:'Staging D1 → recovery bookmark → secret-safe Candidate 0%', risk:'critical', domains:['ekodi.kr/api/finance'] },
  ...
  function installMallFreeOpsNav() {
    ...
    if (!section) {
      ...
      external.href = 'https://ekodi.kr/ekodimall/free-ops';
