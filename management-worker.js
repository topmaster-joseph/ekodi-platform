...
function cfg(env={}){return{
  ...
  authUrl:env.AUTH_URL||'https://ekodi.kr/auth/?site=management&return_to=https%3A%2F%2Fekodi.kr/management%2F',
  minimumTier:'free',
...
export default{async fetch(request,env,ctx){
  ...
  if(url.pathname==='/admin'||url.pathname==='/admin/')return Response.redirect('https://ekodi.kr/admin/?route=organization&source=ekodi.kr/management',307);
