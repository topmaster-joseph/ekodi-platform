...
const SITE_KEYS=Object.freeze([
  'my','space','management','marketing','community','church','mission','bible','pyeonggongmok','life','business','biz','work','author','books','publishing','journal','lab','social','messenger','energy','cafe','mall','shop','delivery','local-commerce','trade','invest','money','pay','edu','learn','support','media','insurance','mail','live','cloud'
]);
export const LANGUAGE_ADMIN_AUTHORITIES=Object.freeze(Object.fromEntries([
  ...
  ['mission',Object.freeze({provider:'supabase-access-api',siteKey:'mission',tenantSlug:'ekodimission'})],
  ...SITE_KEYS.filter(id=>!['biz','mission'].includes(id)).map(id=>[id,Object.freeze({provider:'supabase-access-api',siteKey:id,tenantSlug:''})])
]));
