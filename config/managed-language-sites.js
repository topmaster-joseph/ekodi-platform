...
const SITE_KEYS=Object.freeze([
  'my','space','management','marketing','community','church','mission','bible','life','business','biz','work','author','books','publishing','journal','lab','social','messenger','energy','cafe','mall','shop','delivery','local-commerce','trade','invest','money','pay','edu','learn','support','media','insurance','mail','live','cloud'
]);
