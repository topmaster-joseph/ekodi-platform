...
test('legacy Mall and EKODIBIZ paths redirect to canonical apex paths', async () => {
  for (const [from,to,route] of [
    ...
    ['https://ekodi.kr/mall/admin/publishing','https://ekodi.kr/ekodibiz/ekodimall/admin/publishing','mall-admin-canonical-redirect'],
    ['https://ekodi.kr/ekodibiz/mall?ref=former','https://ekodi.kr/ekodibiz/ekodimall?ref=former','mall-former-canonical-redirect'],
    ['https://ekodi.kr/ekodibiz/mall/admin/channels','https://ekodi.kr/ekodibiz/ekodimall/admin/channel-settings','mall-admin-canonical-redirect'],
    ['https://ekodi.kr/ekodibiz/ekodimall/admin/marketing/channels','https://ekodi.kr/ekodibiz/ekodimall/admin/channel-settings','mall-admin-canonical-redirect'],
