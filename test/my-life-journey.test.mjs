...
test('My EKODI exposes the journey without merging specialist platform data',async()=>{
  const [home,page,app]=await Promise.all([read('my/index.html'),read('my/journey/index.html'),read('my/journey/app.js')]);
  assert.match(home,/href="\/journey\/"/);
  assert.match(home,/MY JOURNEY/);
