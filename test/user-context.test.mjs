...
test('workspace switcher returns through My EKODI',()=>{assert.match(source,/my\.ekodi\.kr/);assert.match(source,/hash='workspaces'/);assert.match(source,/return_to/);});
...
test('context consumes the canonical Shell person-space-role event',()=>{assert.match(source,/ekodi:shell-context/);assert.match(source,/personName/);assert.match(source,/workspaceName/);assert.match(source,/workspaceKey/);});
