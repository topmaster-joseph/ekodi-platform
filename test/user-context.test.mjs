...
test('workspace switcher returns through My EKODI',()=>{assert.match(source,/ekodi\.kr\/my/);assert.match(source,/hash='workspaces'/);assert.match(source,/return_to/);assert.match(source,/공간 전환/);});
