(() => {
  const palettes = [
    ...
    ['#f0caa45c','#afd8bf58','#c9c2df50','21%','20%','80%','28%','58%','80%'],
    ['#efd1af58','#b5d7c458','#c5cce150','17%','27%','79%','21%','62%','83%'],
    ['#ecc7ad58','#abd3c05c','#d0c7de4f','23%','23%','83%','25%','51%','79%'],
  ];
  ...
  function pageLoadSeed() {
    try {
      ...
      return stableHash(`${seoulDateKey()}:${Date.now()}:${globalThis.performance?.timeOrigin || 0}`);
    }
  }
  ...
  async function start() {
    ...
    root.dataset.ambientLoad = seed.toString(36);
