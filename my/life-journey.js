export const EKODI_LIFE_JOURNEY=Object.freeze({
  ...
  stages:[
    {id:'admission',label:'입시',shortLabel:'Admission',state:'active',ownerService:'edu',route:'https://ekodi.kr/education/admission',audience:'all',summary:'학교·과정 탐색부터 전형, 서류, 면접, 합격까지 Education 안에서 준비합니다.',capabilities:['discovery','eligibility','application','documents','interview','decision']},
    {id:'study',label:'학습·유학',shortLabel:'Study',state:'active',ownerService:'edu',route:'https://ekodi.kr/education/study',audience:'all',summary:'국내 학습과 국내외 유학의 학업·생활 준비를 Education 안에서 이어갑니다.',capabilities:['learning','study-abroad','academic-life','mobility','scholarship']},
    {id:'career',label:'취업·진로',shortLabel:'Career',state:'active',ownerService:'work',route:'https://ekodi.kr/work',audience:'all',summary:'개인 프로필, 채용 탐색, 지원, 기업 채용 흐름을 EKODI Work에서 연결합니다.',capabilities:['jobs','talent','recruiting','applications']},
