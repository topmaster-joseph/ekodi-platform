export const EKODI_LIFE_JOURNEY=Object.freeze({
  ...
  stages:[
    {id:'admission',label:'입시',shortLabel:'Admission',state:'planned',ownerService:'edu',futureRoute:'https://edu.ekodi.kr/admission',audience:'all',summary:'학교·과정 탐색부터 전형, 서류, 면접, 합격까지 준비합니다.',capabilities:['discovery','eligibility','application','documents','interview','decision']},
    {id:'study',label:'학습·유학',shortLabel:'Study',state:'planned',ownerService:'edu',futureRoute:'https://edu.ekodi.kr/study',audience:'all',summary:'국내 학습과 국내외 유학의 학업·생활 준비를 이어갑니다.',capabilities:['learning','study-abroad','academic-life','mobility','scholarship']},
