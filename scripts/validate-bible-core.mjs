...
if (bibleBoundary?.canonicalPath !== 'https://ekodi.kr/bible') fail('Bible platform boundary must expose the canonical apex path');
if ((bibleBoundary?.legacyRedirectDomains||[]).length) fail('Bible platform boundary must not retain EKODI-owned legacy child-host aliases');
