...
for(const good of ['https://mail.ekodi.kr/','https://ekodi.kr/ekodibiz/trade','https://ekodi.kr/ekodibiz/marketing-ai','https://cgma.ekodi.kr/','https://ekodi.kr/ekodibiz','https://ekodi.kr/ekodichurch','https://ekodi.kr/ekodilab']) if(!shell.includes(good)) throw new Error('canonical link missing: '+good);
