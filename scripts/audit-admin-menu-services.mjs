...
const lazy=['campus','work','clients','life-ai','community','books','social','aiops','marketing','ai-module-spec','aimembers','supply-network','storage','api-cost','health','security','devices'];
...
const contracts={
  ...
  'community-admin.js':[/dataset\.panel\s*=\s*['\"]community['\"]/,/SERVICE OPERATIONS/],
  'supply-network-admin.js':[/dataset\.panel\s*=\s*['\"]supply-network['\"]/,/판매·공급망/],
};
