...
for(const css of ['client-access.css','books-admin.css','books-finance-admin.css','social-admin.css','marketing-funnel-admin.css']) if(!fs.existsSync(css)) throw new Error('style missing: '+css);
