...
for(const required of ['setSurface','ekodi:shell-theme','ekodi:public-experience','EKODI 다음 행동','suggestedServices','모든 서비스 보기','public-rail','Asia/Seoul','DOCUMENT_LOAD_SEED','--ekodi-public-background-tint','data-ekodi-visual-state'])if(!shellSource.includes(required))fail(`Shell browser source lost public experience marker: ${required}`);
