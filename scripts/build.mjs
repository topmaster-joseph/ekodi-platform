...
for (const asset of htmlAssets) {
  ...
  if (asset === 'control-center.html') {
    ...
    if (!html.includes('admin-authenticated-shell.js')) {
      html = html.replace('</body>', '<script src="admin-authenticated-shell.js?v=20260817-mission-control-1" defer data-ekodi-postauth="compact-control-center.js control-center-features.js campus-actions.js mission-control-admin.css mission-control-admin.js admin-lazy-features.js admin-menu-layout.js ai-ops-admin.js ai-ops-admin.css release-control-admin.js release-control-admin.css work-admin.js work-admin.css marketing-ai-admin.js marketing-ai-admin.css"></script>\n</body>');
    }
  }
