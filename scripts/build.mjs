...
const assets = [
  'index.html','privacy.html','terms.html','history.html','mall.html','mall.css','mall.js','homepage-ambient.css','homepage-ambient.js','admin-shell.html','admin-shell.css','admin-finance.css','admin-central-handoff.js','admin-authenticated-shell.js','admin-public-site-controls.js','admin-demand-loader.js','admin-menu-layout.js','admin-menu-registry.js','admin-sidebar.js','admin-menu-runtime.js','device-control-admin.css','device-control-admin.js','storage-admin.css','storage-admin.js','cheonggye-members-admin.css','cheonggye-members-admin.js','homepage-admin.js','admin-secret-generator.css','admin-secret-generator.js','finance-monitor.js','client-access.css','client-access.js','marketing-funnel-admin.css','marketing-funnel-admin.js','insurance-admin.css','insurance-admin.js','insurance-network-admin.css','insurance-network-admin.js','insurance-advisor-admin.css','insurance-advisor-admin.js','marketing-ai-admin.css','marketing-ai-admin.js','google-admin-auth.css','google-admin-auth.js','ekodi-message-ui.js','domains-hub.css','domains-hub.js','social-admin.css','social-admin.js','release-control-admin.css','release-control-admin.js','community-reports-admin.css','community-reports-admin.js','books-admin.css','books-admin.js','books-finance-admin.css','books-finance-admin.js','admin-compact.css','admin-readable-command.css','admin-readable-command.js','campus-actions.css','campus-actions.js','ai-ops-admin.css','ai-ops-admin.js','common-services-admin.css','common-services-admin.js','capability-center-admin.css','capability-center-admin.js','openai-workspace-admin.css','openai-workspace-admin.js','devotional-admin.css','devotional-admin.js','ai-module-spec-admin.css','ai-module-spec-admin.js','life-ai-admin.css','life-ai-admin.js','personal-finance-admin.css','personal-finance-admin.js','mission-control-admin.css','mission-control-admin.js','work-admin.css','work-admin.js','communication-admin.css','communication-admin.js','admin-lazy-features.js','author-billing-admin.css','author-billing-admin.js','system-health-admin.css','system-health-admin.js','api-cost-admin.css','api-cost-admin.js','device-browser-diagnostics.css','device-browser-diagnostics.js','ekodi-device-bootstrap.cmd','hub.html','trade.html','styles.css','script.js','monitor-status.json','_headers',
];
