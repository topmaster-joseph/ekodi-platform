...
await cp(`${root}shell/character-system.js`, `${output}character-system.js`);
await cp(`${root}shell/character`, `${output}character-assets`, { recursive:true });
