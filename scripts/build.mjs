...
await cp(`${root}sites/seonam-medi/public`, `${output}seonam-medi`, { recursive: true });
...
for (const asset of ['auth.css', 'auth.js', 'auth-bootstrap.js', 'auth-entry.js', 'auth-router.js', 'oauth-consent.js', 'marketing-auth-hotfix.js', 'auth-workspace-target.js', 'admin-auth.js', 'client-auth.js', 'author-auth.js', 'business-auth.js', 'marketing-onboarding.js', 'membership-ui.js', 'google-origin-bridge.js']) await cp(`${root}auth-site/${asset}`, `${output}${asset}`);
...
for (const asset of htmlAssets) {
  ...
  if (asset === 'index.html') {
    ...
    html = html.replaceAll('EKODI선교회', '커뮤니티').replaceAll('에코디선교회', '커뮤니티').replaceAll('https://youtube.com/@ekodicommunity', 'https://ekodi.kr/community').replaceAll('https://www.youtube.com/@ekodicommunity', 'https://ekodi.kr/community');
