...
if (registry.architectureVersion !== '1.8.0') fail('sovereign operations architectureVersion must be 1.8.0');
...
if (constitution.version !== '1.8.0') fail('constitution must be v1.8.0');
if (constitution.architectureModel?.operatingArchitectureVersion !== '1.8.0') fail('constitution operating architecture version mismatch');
...
if (architecture.operatingArchitectureVersion !== '1.8.0') fail('architecture registry operating version mismatch');
...
if (evolution.operatingArchitectureVersion !== '1.8.0') fail('evolution model operating architecture version mismatch');
...
console.log('EKODI Sovereign Autonomous Operations v1.8.0: OK');
