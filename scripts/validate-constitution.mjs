...
if (constitution.version !== '1.15.0') fail('constitution version must be 1.15.0 with the approved Supreme Attributes amendment and all prior approved amendments');
