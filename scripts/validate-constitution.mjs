...
if(publicUserSurface.anonymousReadAccessRequired!==true||publicUserSurface.signedInBasicAccess!=='free-by-default'||publicUserSurface.basicCapabilitiesRequirePaidSubscription!==false) fail('public pages must allow anonymous reading and free signed-in basic capabilities');
if(publicUserSurface.premiumCapabilities!=='subscription-or-explicit-entitlement'||publicUserSurface.entitlementUpgradeMustNotBlockPublicOrBasicExperience!==true) fail('premium entitlement must remain additive and may not block public/basic experience');
