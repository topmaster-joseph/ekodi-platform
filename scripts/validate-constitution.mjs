...
if (constitution.version !== '1.9.2') fail('constitution version must be 1.9.2 with the approved completion-only reporting amendment and all prior approved amendments');
