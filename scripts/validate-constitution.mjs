...
if (constitution.version !== '1.5.2') fail('constitution version must remain 1.5.2 with approved orgless routing, Invest common-service and CGMA public-domain amendments');
