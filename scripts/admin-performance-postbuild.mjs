...
const versionInputs = [
  ...
  'ai-ops-admin.js','ai-ops-admin.css','ai-management-admin.js','ai-management-admin.css','ai-module-spec-admin.js','ai-module-spec-admin.css','ai-module-registry-admin.js','ai-module-registry-admin.css','life-ai-admin.js','life-ai-admin.css','mission-control-admin.js','mission-control-admin.css',
...
if (bytes.demand > 14200) throw new Error(`Demand loader budget exceeded: ${bytes.demand} bytes`);
