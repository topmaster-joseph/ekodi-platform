...
for (const [from,to] of [['ASSET_VERSION','AV'],['separator','sep'],['existing','ex'],['promise','pr'],['finish','fin'],['observer','obs'],['content','ct'],['timer','tm'],['callback','cb'],['handler','hd'],['placeholder','ph'],['requestedKey','rk'],['selector','sl'],['settled','st'],['deadline','dl'],['index','ix'],['changed','ch'],['secondaryScripts','sjs'],['secondaryStyles','scs'],['financeAssetsRequested','far'],['financeDemandBound','fdb']]) {
