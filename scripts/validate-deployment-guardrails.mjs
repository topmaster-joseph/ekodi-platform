...
// Staging is intentionally isolated in the Cloudflare Development account and verified
// through the generated staging config plus a local Worker runtime. Public staging
// hostnames were retired because they can be blocked by Access and can accidentally
// couple Development verification to Production DNS topology.
requireText('.github/workflows/deploy-control-api.yml', [
  'environment: development',
  '46aad4738793fbaca88574832a2ccc0f',
  'ekodi-auth-staging',
  'workers_dev = true',
  'wrangler@$WRANGLER_VERSION dev --local',
  'd1 time-travel info',
...
console.log('✅ Deployment policy audit passed: production deploys remain guarded while staging stays isolated in the Development account and retired admin compatibility stays manual-only.');
