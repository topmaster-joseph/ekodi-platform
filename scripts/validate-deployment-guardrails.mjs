...
const workerGuarded = {
  '.github/workflows/deploy-site-core.yml': ['guarded-worker-release.mjs', 'shared-site.worker.json', 'reliability_gate:', 'reliability-validation.yml', 'needs: [staging_gate, reliability_gate]'],
...
for (const file of ['.github/workflows/deploy-service-proxy.yml']) {
