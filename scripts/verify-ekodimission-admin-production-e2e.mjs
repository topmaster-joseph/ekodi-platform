...
try{
  ...
  await signedOutPage.waitForFunction(()=>document.querySelector('#adminNav')?.textContent?.includes('콘텐츠 · 운영'));
  await signedOutPage.waitForFunction(()=>document.querySelector('#sectionNav')?.textContent?.includes('행사 · 신청자'));
