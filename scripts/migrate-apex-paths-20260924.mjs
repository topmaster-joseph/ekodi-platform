...
2. EKODI 소유 \`*.ekodi.kr\` 하위도메인은 생성·유지·리다이렉트·호환 별칭으로 보존하지 않는다.
...
const amendment={
  ...
  summary:'Remove all EKODI-owned *.ekodi.kr addresses and make ekodi.kr path routing the only EKODI-owned address model.',
