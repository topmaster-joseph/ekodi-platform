...
if(policy.sessionExecutor?.textPattern!=='^EKODI_SESSION_[A-Z0-9_-]{8,64}$'||policy.sessionExecutor?.rawInputReturnedInCloudResult!==false||policy.sessionExecutor?.inputOutputHashesRequired!==true) fail('bounded isolated session payload/evidence contract drifted');
