...
function mergeExecutionResult(result = {}, execution = {}) {
  ...
  const evidence = Object.freeze({
    ...
    executionAttempts: execution.executionAttempts || result.evidence?.executionAttempts || Object.freeze([]),
    executionFallbackUsed: execution.fallbackUsed === true,
    selectedExecutionAdapter: execution.selectedAdapterId || execution.executionReceipt?.adapterId || null,
  ...
  return Object.freeze({
    ...
    execution: Object.freeze({
      ...
      selectedAdapterId: execution.selectedAdapterId || execution.executionReceipt?.adapterId || null,
      fallbackUsed: execution.fallbackUsed === true,
      attempts: execution.executionAttempts || Object.freeze([]),
    }),
    evidence,
  });
}
