...
function render(){
  ...
  host.innerHTML=`<div class="pf-admin-head"><div><p class="kicker">전문서비스 · PERSONAL FINANCE</p><h2>개인재무 운영 설정</h2><p>개인 금융원장의 내용은 이 화면에서 조회하지 않습니다. 서비스 상태·기능 경계·안전정책만 관리합니다.</p></div><div class="pf-admin-actions"><a class="secondary" href="https://ekodi.kr/my/#money" target="_blank" rel="noopener">My EKODI 열기 ↗</a><button id="pfAdminRefresh" class="secondary" type="button">↻ 새로고침</button></div></div>
