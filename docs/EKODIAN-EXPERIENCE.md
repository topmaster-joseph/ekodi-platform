...
The shared implementation lives in `shell/character-system.js`. Visual assets are versioned shared Shell assets, so rollout remains provider-independent, reversible, and compatible with later governed asset-management expansion.
