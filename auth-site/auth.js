...
const services={
  ...
  trade:{name:'EKODI Global Trading',tenant:'ekoditrade',role:'member',returnTo:'https://ekodi.kr/ekodibiz/trade',origins:['https://ekodi.kr','https://trade.biz.ekodi.kr','https://trade.ekodi.kr'],requestable:false},
  mall:{name:'에코디몰',tenant:null,role:'member',returnTo:'https://ekodi.kr/ekodibiz/ekodimall',origins:['https://ekodi.kr'],requestable:true},
  ...
  oauth:{name:'EKODI AI 연결',tenant:null,role:'member',returnTo:'https://ekodi.kr/auth/oauth/consent',origins:['https://ekodi.kr'],requestable:false},
