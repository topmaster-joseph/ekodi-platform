(() => {
  ...
  const preopenedAdminBridge = params.get('direct') === '1' && params.get('bridge') === 'preopened';
  ...
  document.documentElement.dataset.adminDirectBridge = directAdmin || preopenedAdminBridge ? '1' : '0';
})();
