...
const safeReturn=(()=>{try{const u=new URL(rawReturn);if(u.protocol!=='https:')return'https://ekodi.kr/admin/';if(u.origin==='https://admin.ekodi.kr')return u.href;if(u.origin==='https://ekodi.kr'&&(u.pathname==='/admin'||u.pathname.startsWith('/admin/')||u.pathname==='/ekodibiz/mall/admin'||u.pathname.startsWith('/ekodibiz/mall/admin/')))return u.href;if(u.origin==='https://ai.ekodi.kr'&&u.pathname==='/')return u.href;if(u.origin==='https://tax.ekodi.kr'&&(u.pathname==='/'||u.pathname==='/index.html'))return u.href;return'https://ekodi.kr/admin/'}catch{return'https://ekodi.kr/admin/'}})();
