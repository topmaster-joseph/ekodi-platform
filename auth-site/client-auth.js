...
async function prepare(){
  const host=$('googleButtonHost');host.replaceChildren();show('googleRetry',false);notice('사전등록 고객용 Google 인증을 준비하고 있습니다.');
  try{
    ...
    notice('Control Center에 등록된 고객 이메일과 같은 Google 계정으로 계속해 주세요.');
