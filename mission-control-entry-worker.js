...
export default {
  async fetch(request, env, ctx) {
    ...
    // Author billing is intentionally isolated from the shared membership router.
    // D1 is the billing source of truth and every paid Author AI call re-verifies it.
