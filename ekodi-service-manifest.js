...
const SERVICES = [
  ...
  {id:'books',name:'에코디서점',shortName:'Bookstore',url:'https://books.ekodi.kr/',group:'knowledge',defaultSurface:'public',workspaceKinds:['person','business','organization'],capabilities:['publishing','books','distribution'],sso:true,targetable:true,order:90,shellIntegration:'worker-injected'},
