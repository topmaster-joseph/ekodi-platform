...
const SERVICES = [
  ...
  {id:'biz',name:'에코디비즈',shortName:'Biz',url:'https://biz.ekodi.kr/',group:'business',defaultSurface:'public',workspaceKinds:['business','organization'],capabilities:['business','trade','commerce'],sso:true,targetable:true,order:60,readyLocales:['ko-KR','en','zh-CN','ja','ne','vi'],shellIntegration:'shared-proxy'},
  ...
  {id:'trade',name:'EKODI Global Trading',shortName:'Trade',url:'https://trade.biz.ekodi.kr/',group:'business',defaultSurface:'public',workspaceKinds:['business','organization'],capabilities:['trade','buyers','suppliers'],sso:true,targetable:true,order:140,shellIntegration:'worker-injected'},
