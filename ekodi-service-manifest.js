...
const SERVICES = [
  ...
  {id:'pgm',name:'평공목',shortName:'평공목',url:'https://ekodi.kr/pgm',group:'ministry',defaultSurface:'public',workspaceKinds:['person','church','community','organization'],capabilities:['pastor-learning','theology','sermon-study','ministry-practice','study-archive'],sso:true,targetable:true,openSso:true,order:46,state:'live',shellIntegration:'worker-injected',authMode:'client',onboardingVersion:1},
