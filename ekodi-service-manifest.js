...
const SERVICES = [
  {id:'my',name:'My EKODI',shortName:'My',url:'https://ekodi.kr/my/',group:'personal',defaultSurface:'workspace',workspaceKinds:['person','business','organization','church','community','project'],capabilities:['identity','spaces','activity','account'],sso:true,targetable:false,order:10,shellIntegration:'worker-injected'},
  {id:'space',name:'운영공간',shortName:'Space',url:'https://ekodi.kr/space',group:'work',defaultSurface:'workspace',selectorHidden:true,workspaceKinds:['person','business','organization','church','community','project'],capabilities:['operating-space','workspace-identity','roles','capabilities','membership'],sso:true,targetable:true,openSso:true,order:12,state:'live',shellIntegration:'worker-injected',authMode:'client',onboardingVersion:1},
  {id:'management',name:'경영플랫폼',shortName:'경영AI',url:'https://ekodi.kr/management/',group:'business',defaultSurface:'public',workspaceKinds:['person','business','organization','community','project'],capabilities:['management','orchestration','module-selection','menu','orders','reviews'],sso:true,targetable:true,openSso:true,order:15,state:'preparing',shellIntegration:'worker-injected',authMode:'client',onboardingVersion:1},
  {id:'marketing',name:'Marketing AI',shortName:'Marketing',url:'https://ekodi.kr/ekodibiz/marketing-ai',engineUrl:'https://ekodi.kr/marketing/',group:'business',defaultSurface:'public',workspaceKinds:['person','business','organization','church','community','project'],capabilities:['marketing','content','publishing','analytics'],sso:true,targetable:true,order:20,shellIntegration:'static-script'},
  ...
  {id:'work',name:'EKODI Work',shortName:'Work',url:'https://ekodi.kr/work',group:'work',defaultSurface:'public',workspaceKinds:['person','business','organization'],capabilities:['jobs','talent','recruiting'],sso:true,targetable:false,order:70,shellIntegration:'worker-injected'},
  {id:'author',name:'Creator AI',shortName:'Creator',url:'https://ekodi.kr/author',group:'creator',defaultSurface:'workspace',workspaceKinds:['person','organization'],capabilities:['creator','writing','media'],sso:true,targetable:false,order:80,shellIntegration:'worker-injected'},
  {id:'books',name:'에코디서점',shortName:'Bookstore',url:'https://ekodi.kr/books',group:'knowledge',defaultSurface:'public',workspaceKinds:['person','business','organization'],capabilities:['books','catalog','storefront','commerce'],sso:true,targetable:true,order:90,shellIntegration:'worker-injected'},
  {id:'publishing',name:'출판',shortName:'Publishing',url:'https://ekodi.kr/publishing',group:'knowledge',defaultSurface:'public',workspaceKinds:['person','business','organization','church','community','project'],capabilities:['publishing','consultation','production','publishing-agency','distribution','studio'],sso:true,targetable:true,openSso:true,order:95,state:'live',shellIntegration:'worker-injected',authMode:'client',onboardingVersion:1},
  {id:'journal',name:'에코디 저널',shortName:'Journal',url:'https://ekodi.kr/journal',group:'knowledge',defaultSurface:'public',workspaceKinds:['person','business','organization','church','community','project'],capabilities:['journal','editorial','publishing','archive','feed'],sso:true,targetable:true,openSso:true,order:97,state:'live',readyLocales:['ko-KR','en','zh-CN','ja','vi'],shellIntegration:'worker-injected',authMode:'client',onboardingVersion:1},
  {id:'lab',name:'에코디연구소',shortName:'Lab',url:'https://ekodi.kr/ekodilab',group:'knowledge',defaultSurface:'public',workspaceKinds:['person','organization','project'],capabilities:['research','projects','knowledge'],sso:true,targetable:true,order:100,shellIntegration:'shared-proxy'},
  {id:'social',name:'EKODI Social',shortName:'Social',url:'https://ekodi.kr/social',group:'community',defaultSurface:'workspace',workspaceKinds:['person','business','organization','church','community'],capabilities:['social','channels'],sso:true,targetable:true,openSso:true,order:110,shellIntegration:'worker-injected'},
  {id:'messenger',name:'EKODI Messenger',shortName:'Messenger',url:'https://ekodi.kr/messenger',group:'communication',defaultSurface:'workspace',workspaceKinds:['person','business','organization','church','community','project'],capabilities:['messaging','ai-assist','handoff','notifications','commands'],sso:true,targetable:true,openSso:true,order:115,shellIntegration:'shared-proxy',authMode:'client',onboardingVersion:1},
  {id:'energy',name:'Energy AI',shortName:'Energy',url:'https://ekodi.kr/energy',group:'life',defaultSurface:'workspace',workspaceKinds:['person','business','organization'],capabilities:['energy','solar','electricity'],sso:true,targetable:true,openSso:true,order:120,shellIntegration:'worker-injected'},
  {id:'cafe',name:'에코디 카페',shortName:'Cafe',url:'https://ekodi.kr/cafe/',group:'community',defaultSurface:'public',workspaceKinds:['person','community','church','organization','project'],capabilities:['place','community','culture','local','imagination'],sso:true,targetable:true,order:125,state:'preparing',shellIntegration:'static-script',onboardingVersion:1},
  {id:'mall',name:'에코디몰',shortName:'Mall',url:'https://ekodi.kr/ekodimall',group:'business',defaultSurface:'public',workspaceKinds:['person','business','organization'],capabilities:['commerce','affiliate-curation','products'],sso:true,targetable:true,order:130,shellIntegration:'shared-proxy'},
  {id:'shop',name:'쇼핑플랫폼',shortName:'Shop',url:'https://ekodi.kr/shop/',group:'business',defaultSurface:'public',workspaceKinds:['person','business','organization','church','community'],capabilities:['commerce-platform','store-creation','multi-tenant'],sso:true,targetable:true,order:135,state:'planned',shellIntegration:'planned',onboardingVersion:1},
  ...
  {id:'money',name:'EKODI Money',shortName:'Money',url:'https://ekodi.kr/money/',group:'finance',defaultSurface:'workspace',workspaceKinds:['person','business','organization','church','community'],capabilities:['financial-cleanup','accounts','autopay','financial-relationships','decision-support','official-handoff'],sso:true,targetable:true,openSso:true,order:147,shellIntegration:'worker-injected',authMode:'client',onboardingVersion:1,transactionMode:'human-confirmed-official-handoff'},
  {id:'pay',name:'EKODI Pay',shortName:'Pay',url:'https://ekodi.kr/pay/',group:'finance',defaultSurface:'public',workspaceKinds:['person','business','organization'],capabilities:['payments','billing'],sso:true,targetable:true,order:150,shellIntegration:'worker-injected'},
  {id:'edu',name:'EKODI Education',shortName:'Education',url:'https://ekodi.kr/education/',group:'knowledge',defaultSurface:'public',workspaceKinds:['person','church','community','organization'],capabilities:['education','courses','learning','admission','study','official-sources','planning'],sso:true,targetable:true,openSso:true,order:160,shellIntegration:'worker-injected',authMode:'client',onboardingVersion:1},
  ...
  {id:'support',name:'Support Opportunity AI',shortName:'Support',url:'https://ekodi.kr/support/',group:'business',defaultSurface:'workspace',workspaceKinds:['person','business','organization','church','community','project'],capabilities:['government-support','opportunities','grants','official-sources','forms','project-lifecycle'],sso:true,targetable:true,openSso:true,order:165,shellIntegration:'worker-injected',authMode:'client',onboardingVersion:1},
  {id:'media',name:'에코디미디어',shortName:'Media',url:'https://ekodi.kr/media/',group:'creator',defaultSurface:'public',workspaceKinds:['person','church','community','organization'],capabilities:['media','video','live'],sso:true,targetable:true,order:170,state:'planned',shellIntegration:'planned'},
  {id:'insurance',name:'에코디보험',shortName:'Insurance',url:'https://ekodi.kr/insurance',group:'life',defaultSurface:'public',workspaceKinds:['person','business','organization'],capabilities:['insurance','coverage','claims'],sso:true,targetable:true,order:180,state:'live',shellIntegration:'worker-injected'},
  {id:'mail',name:'EKODI Mail',shortName:'Mail',url:'https://ekodi.kr/mail/',group:'communication',defaultSurface:'workspace',workspaceKinds:['person','business','organization','church','community'],capabilities:['mail','communication'],sso:true,targetable:true,order:190,state:'planned',shellIntegration:'planned'},
  {id:'live',name:'EKODI Live',shortName:'Live',url:'https://ekodi.kr/live',group:'communication',defaultSurface:'public',workspaceKinds:['person','business','organization','church','community'],capabilities:['live','broadcast','site-visibility','recording-admin'],sso:true,targetable:true,order:200,state:'live',shellIntegration:'worker-injected',authMode:'client',onboardingVersion:1},
  {id:'cloud',name:'EKODI Cloud',shortName:'Cloud',url:'https://ekodi.kr/cloud/',group:'communication',defaultSurface:'workspace',workspaceKinds:['person','business','organization','church','community','project'],capabilities:['files','collaboration','cloud'],sso:true,targetable:true,order:210,state:'planned',shellIntegration:'planned'}
].map(service=>{
