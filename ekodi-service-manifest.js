...
const SERVICES = [
  ...
  {id:'journal',name:'에코디 저널',shortName:'Journal',url:'https://journal.ekodi.kr/',group:'knowledge',defaultSurface:'public',workspaceKinds:['person','business','organization','church','community','project'],capabilities:['journal','editorial','publishing','archive','feed'],sso:true,targetable:true,openSso:true,order:97,state:'preparing',shellIntegration:'worker-injected',authMode:'client',onboardingVersion:1},
  ...
  {id:'trade',name:'EKODI Global Trading',shortName:'Trade',url:'https://ekodi.kr/ekoditrade',group:'business',defaultSurface:'public',workspaceKinds:['business','organization'],capabilities:['trade','buyers','suppliers'],sso:true,targetable:true,order:140,shellIntegration:'worker-injected'},
