export const EKODI_SERVICE_MANIFEST = Object.freeze({
  ...
  services: [
    ...
    {id:'social',name:'EKODI Social',shortName:'Social',url:'https://social.ekodi.kr/',group:'community',workspaceKinds:['person','business','organization','church','community'],capabilities:['social','channels'],sso:true,targetable:true,openSso:true,order:110},
    {id:'energy',name:'EKODI Energy AI',shortName:'Energy',url:'https://energy.ekodi.kr/',group:'life',workspaceKinds:['person','business','organization'],capabilities:['energy','solar','electricity'],sso:true,targetable:true,openSso:true,order:120},
