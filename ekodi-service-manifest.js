...
const SERVICES = [
  ...
  {id:'mall',name:'에코디몰',shortName:'Mall',url:'https://ekodi.kr/ekodibiz/mall',group:'business',defaultSurface:'public',workspaceKinds:['person','business','organization'],capabilities:['commerce','affiliate-curation','products'],sso:true,targetable:true,order:130,shellIntegration:'shared-proxy'},
  ...
  {id:'edu',name:'EKODI Learning Fabric',shortName:'Learning',url:'https://ekodi.kr/learn',group:'knowledge',defaultSurface:'public',workspaceKinds:['person','church','community','organization'],capabilities:['education','courses','learning','skills','progress','ai-coach'],sso:true,targetable:true,openSso:true,order:160,state:'live',shellIntegration:'worker-injected',authMode:'client',onboardingVersion:1},
