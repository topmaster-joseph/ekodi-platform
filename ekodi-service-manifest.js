...
const SERVICES = [
  ...
  {id:'experience',name:'에코디 체험',shortName:'Try',url:'https://try.ekodi.kr/',group:'platform',defaultSurface:'public',workspaceKinds:['person','business','organization','church','community','project'],capabilities:['experience','simulation','service-discovery','developer-view'],sso:true,targetable:true,openSso:true,order:98,state:'live',shellIntegration:'worker-injected',authMode:'optional',onboardingVersion:1},
