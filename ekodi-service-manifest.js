...
const SERVICES = [
  ...
  {id:'mission',name:'에코디선교회',shortName:'Mission',url:'https://ekodi.kr/ekodimission',group:'ministry',defaultSurface:'public',workspaceKinds:['organization','church','community','person','project'],capabilities:['mission','hospitality','activities','partnerships','giving-information'],sso:true,targetable:false,order:42,state:'preparing',shellIntegration:'external-build',onboardingVersion:1},
