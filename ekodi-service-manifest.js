...
const SERVICES = [
  ...
  {id:'marketing',name:'Marketing AI',shortName:'Marketing',url:'https://ekodi.kr/ekodibiz/marketing-ai',engineUrl:'https://ekodi.kr/ekodibiz/marketing-ai',group:'business',defaultSurface:'public',workspaceKinds:['person','business','organization','church','community','project'],capabilities:['marketing','content','publishing','analytics'],sso:true,targetable:true,order:20,shellIntegration:'static-script'},
  ...
  {id:'mall',name:'에코디몰',shortName:'Mall',url:'https://ekodi.kr/ekodibiz/ekodimall',group:'business',defaultSurface:'public',workspaceKinds:['person','business','organization'],capabilities:['commerce','affiliate-curation','products'],sso:true,targetable:true,order:130,shellIntegration:'shared-proxy'},
  ...
  {id:'live',name:'EKODI Live',shortName:'Live',url:'https://ekodi.kr/live',group:'communication',defaultSurface:'workspace',workspaceKinds:['person','business','organization','church','community'],capabilities:['live','broadcast'],sso:true,targetable:true,order:200,state:'planned',shellIntegration:'planned'},
