...
const SERVICES = [
  ...
  {id:'biz',name:'에코디비즈',shortName:'Biz',url:'https://ekodi.kr/ekodibiz',group:'business',defaultSurface:'public',workspaceKinds:['business','organization'],capabilities:['business','trade','commerce'],sso:true,targetable:true,order:60,shellIntegration:'shared-proxy'},
  ...
  {id:'journal',name:'에코디 저널',shortName:'Journal',url:'https://journal.ekodi.kr/',group:'knowledge',defaultSurface:'public',workspaceKinds:['person','business','organization','church','community','project'],capabilities:['journal','editorial','publishing','archive','feed'],sso:true,targetable:true,openSso:true,order:97,state:'live',shellIntegration:'worker-injected',authMode:'client',onboardingVersion:1},
  ...
  {id:'insurance',name:'에코디보험',shortName:'Insurance',url:'https://ekodi.kr/insurance',group:'life',defaultSurface:'public',workspaceKinds:['person','business','organization'],capabilities:['insurance','coverage','claims'],sso:true,targetable:true,order:180,state:'planned',shellIntegration:'planned'},
