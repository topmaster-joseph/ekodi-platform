...
const CORS_ORIGINS=new Set(['https://ekodi.kr/life','https://ekodi.kr']);
...
export default{
  async fetch(request,env){
    ...
    if(url.pathname==='/admin'||url.pathname==='/admin/')return Response.redirect('https://ekodi.kr/admin/#life-ai',307);
