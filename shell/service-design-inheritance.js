...
'use strict';
const VERSION=3;
const DEFAULT={accent:'#315d48',accent2:'#7fa9c8',warm:'#c79a45',leaf:'#6f9e7a',paper:'#fffdf8',ink:'#25332b',radius:'18px',softRadius:'12px',shadow:'0 18px 48px rgba(24,38,31,.10)',density:'medium',motion:'gentle'};
const DESIGNS={
...
management:{accent:'#84cc4f',accent2:'#69aef5',warm:'#f4ba58',leaf:'#79a66f',paper:'#fffdf7',ink:'#1f2d3d',radius:'22px',softRadius:'14px',density:'medium',motion:'guided',mood:'decision-map'},
bible:{accent:'#36a77a',accent2:'#b6a4ed',warm:'#f4a66c',leaf:'#78b88b',paper:'#fffaf3',ink:'#17233a',radius:'26px',softRadius:'999px',density:'low-medium',motion:'gentle',mood:'living-word-garden'},
life:{accent:'#5078d8',accent2:'#ef8d79',warm:'#f2c95e',leaf:'#68ae8d',paper:'#fcfdff',ink:'#25314b',radius:'24px',softRadius:'999px',density:'low-medium',motion:'branch',mood:'question-compass'},
delivery:{accent:'#3679d1',accent2:'#f28a48',warm:'#f4be58',leaf:'#55a975',paper:'#fffdf8',ink:'#243247',radius:'18px',softRadius:'999px',density:'medium-high',motion:'route',mood:'dispatch-map'},
...
function serviceId(){const explicit=document.documentElement.dataset.ekodiService||document.body?.dataset?.ekodiService;if(explicit)return String(explicit).toLowerCase();const sub=String(location.hostname||'').split('.')[0].toLowerCase();return HOST_ALIAS[sub]||sub||'my';}
function designFor(id=serviceId()){return {...DEFAULT,...(DESIGNS[id]||DESIGNS.my)};}
function apply(id=serviceId()){
const d=designFor(id),root=document.documentElement,style=root.style;
root.dataset.ekodiService=id;root.dataset.ekodiDesignInheritance=`v${VERSION}`;root.dataset.ekodiDesignMood=d.mood;root.dataset.ekodiDesignDensity=d.density;root.dataset.ekodiDesignMotion=d.motion;
for(const [key,value] of Object.entries({'--ekodi-service-accent':d.accent,'--ekodi-service-accent-2':d.accent2,'--ekodi-service-warm':d.warm,'--ekodi-service-leaf':d.leaf,'--ekodi-service-paper':d.paper,'--ekodi-service-ink':d.ink,'--ekodi-service-radius':d.radius,'--ekodi-service-radius-soft':d.softRadius,'--ekodi-service-shadow':d.shadow,'--ekodi-service-density':d.density,'--ekodi-service-motion':d.motion,'--ekodi-ill-accent':d.accent,'--ekodi-ill-sky':d.accent2,'--ekodi-ill-sun':d.warm,'--ekodi-ill-leaf':d.leaf}))style.setProperty(key,value);
if(!style.getPropertyValue('--accent'))style.setProperty('--accent',d.accent);
window.dispatchEvent(new CustomEvent('ekodi:design-inherited',{detail:{service:id,version:VERSION,design:d}}));return d;
}
const css=`:root[data-ekodi-design-inheritance]{--ekodi-card-radius:var(--ekodi-service-radius);--ekodi-button-radius:var(--ekodi-service-radius-soft);--ekodi-panel-shadow:var(--ekodi-service-shadow)}:root[data-ekodi-design-inheritance] .ekodi-card,:root[data-ekodi-design-inheritance] [data-ekodi-card],:root[data-ekodi-design-inheritance] .ekodi-panel{border-radius:var(--ekodi-service-radius)!important}:root[data-ekodi-design-inheritance] .ekodi-primary,:root[data-ekodi-design-inheritance] [data-ekodi-primary],:root[data-ekodi-design-inheritance] .ekodi-cta{background:var(--ekodi-service-accent)!important}:root[data-ekodi-design-inheritance] .ekodi-soft-surface,:root[data-ekodi-design-inheritance] [data-ekodi-soft-surface]{background:color-mix(in srgb,var(--ekodi-service-accent) 8%,var(--ekodi-service-paper))!important}:root[data-ekodi-design-inheritance] .ekodi-friendly-empty,:root[data-ekodi-design-inheritance] .ekodi-friendly-welcome,:root[data-ekodi-design-inheritance] .ekodi-message-ui{--accent:var(--ekodi-service-accent)}[data-ekodi-shell-surface="admin"]{--ekodi-service-shadow:0 10px 30px rgba(0,0,0,.16)}[data-ekodi-shell-surface="admin"] .ekodi-illustration{filter:saturate(.72);opacity:.9}@media(prefers-reduced-motion:reduce){:root[data-ekodi-design-inheritance]{scroll-behavior:auto!important}}`;
