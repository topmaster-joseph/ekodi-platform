...
function clientMain(){
  ...
  function marketingPanel(){$('mainPanel').innerHTML=`<h2>자담치킨 Marketing AI</h2><p class="panel-lead">다른 점포와 데이터·권한이 분리된 자담치킨 전용 마케팅 운영공간입니다.</p><div class="actions"><a class="button primary" href="/jadam/marketing">전용 Marketing AI 열기</a></div>`}
