...
function securityHeaders(contentType) {
  return new Headers({
    ...
    'content-security-policy':"default-src 'self'; script-src 'self'; style-src 'self'; connect-src https://ekodi.kr; img-src 'self' data:; object-src 'none'; frame-ancestors 'none'; base-uri 'none'; form-action 'none'",
  });
}
