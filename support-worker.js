...
export const BENEFIT_RADAR_CAPABILITY=Object.freeze({id:'support.benefit-radar',generation:10,contract:'ekodi.benefit-radar.v1',actionTier:'assist',execution:'recommendation-and-prep-only',highImpact:'human-gated',consent:'consent-first'});
