...
import { injectEkodiShell, injectEkodiUserUi, shellServiceForHost } from './ekodi-shell-injector.js';
...
export default {
  async fetch(request, env, ctx) {
    ...
    if (effective.host === PUBLIC_HOST) return injectEkodiUserUi(response, 'ekodi', 'public');
