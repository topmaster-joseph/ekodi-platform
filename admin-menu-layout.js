...
const HASH_SECTIONS = new Map([
  ['#sites', 'sites'], ['#ai-ops', 'aiops'], ['#ai-module-spec', 'ai-module-spec'], ['#health', 'health'], ['#storage', 'storage'], ['#security', 'security'], ['#architecture', 'architecture'], ['#devices', 'devices'], ['#campus', 'campus'],
  ['#policies', 'policies'], ['#operations', 'overview'], ['#services', 'services'], ['#deployments', 'deployments'],
]);
const CANONICAL_HASH = new Map([
  ['overview', '#operations'], ['sites', '#sites'], ['aiops', '#ai-ops'], ['ai-module-spec', '#ai-module-spec'], ['health', '#health'], ['storage', '#storage'], ['security', '#security'], ['architecture', '#architecture'], ['devices', '#devices'], ['campus', '#campus'],
]);
