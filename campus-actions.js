(() => {
  const ALL_SITES = [
    ...
    { type: 'Control', name: 'EKODI Admin', domain: 'ekodi.kr/admin', section: 'admins', fallback: 'services', group: 'core' },
    { type: 'Auth', name: 'EKODI Auth', domain: 'ekodi.kr/auth', section: 'admins', fallback: 'services', group: 'core' },
    { type: '교회', name: '에코디교회', domain: 'ekodi.kr/ekodichurch', section: 'services', group: 'community' },
    { type: '비즈', name: '에코디비즈', domain: 'ekodi.kr/ekodibiz', section: 'organization', fallback: 'services', group: 'business' },
    { type: 'OS', name: '비즈니스 OS', domain: 'ekodi.kr/business', section: 'services', group: 'business' },
    { type: '출판', name: '에코디서점', domain: 'ekodi.kr/books', section: 'books', fallback: 'services', group: 'knowledge' },
    { type: '작가AI', name: '크리에이터 AI', domain: 'ekodi.kr/author', section: 'books', fallback: 'services', group: 'knowledge' },
    { type: '연구소', name: '에코디연구소', domain: 'ekodi.kr/ekodilab', section: 'services', group: 'knowledge' },
    { type: '교육', name: '에코디교육', domain: 'ekodi.kr/education', section: 'services', group: 'knowledge' },
    { type: '커뮤니티', name: '커뮤니티', domain: 'ekodi.kr/community', section: 'community', fallback: 'services', group: 'community' },
    { type: '소셜', name: '에코디 소셜', domain: 'ekodi.kr/social', section: 'social', fallback: 'services', group: 'community' },
    { type: '몰', name: '에코디몰', domain: 'ekodi.kr/ekodimall', section: 'services', group: 'business' },
    { type: '마케팅', name: '마케팅 AI', domain: 'ekodi.kr/marketing', section: 'services', group: 'business' },
    { type: '무역', name: '에코디 트레이딩', domain: 'ekodi.kr/ekodibiz/trade', section: 'organization', fallback: 'services', group: 'business' },
    { type: '결제', name: '에코디 페이', domain: 'ekodi.kr/pay', section: 'finance', fallback: 'services', group: 'business' },
    { type: 'My', name: '마이 에코디', domain: 'ekodi.kr/my', section: 'services', group: 'worklife' },
    { type: '워크', name: '에코디 워크', domain: 'ekodi.kr/work', section: 'work', fallback: 'services', group: 'worklife' },
    { type: '에너지', name: '에너지 AI', domain: 'ekodi.kr/energy', section: 'services', group: 'worklife' },
    ...
    { type: '메일', name: '에코디 메일', domain: 'ekodi.kr/mail', section: 'communication', fallback: 'services', group: 'communication', lifecycle: 'planned' },
    { type: '라이브', name: '에코디 라이브', domain: 'ekodi.kr/live', section: 'communication', fallback: 'services', group: 'communication', lifecycle: 'planned' },
    { type: '클라우드', name: '에코디 클라우드', domain: 'ekodi.kr/cloud', section: 'workspace', fallback: 'services', group: 'communication', lifecycle: 'planned' },
    { type: '미디어', name: '에코디미디어', domain: 'ekodi.kr/media', section: 'communication', fallback: 'services', group: 'communication', lifecycle: 'planned' },
    { type: '고객', name: '청계면상인회', domain: 'ekodi.kr/cgma', url: 'https://ekodi.kr/cgma/', label: 'ekodi.kr/cgma · cgma.or.kr', section: 'clients', fallback: 'services', group: 'clients' },
    { type: '고객', name: '자담치킨 목포대점', domain: 'ekodi.kr/jadam', section: 'clients', fallback: 'services', group: 'clients' },
    { type: '고객', name: '피자마루 목포대점', domain: 'ekodi.kr/pizzamaru', section: 'clients', fallback: 'services', group: 'clients' },
    { type: '고객', name: '요거트퍼플 목포대점', domain: 'ekodi.kr/yogurt', section: 'clients', fallback: 'services', group: 'clients' },
  ];
