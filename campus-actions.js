(() => {
  const ALL_SITES = [
    ...
    { type: 'OS', name: 'Business OS', domain: 'business.ekodi.kr', section: 'services', group: 'business' },
    { type: '출판', name: '에코디북스', domain: 'books.ekodi.kr', section: 'books', fallback: 'services', group: 'knowledge' },
    { type: '작가AI', name: 'Creator AI', domain: 'author.ekodi.kr', section: 'books', fallback: 'services', group: 'knowledge' },
    ...
    { type: '마케팅', name: 'Marketing AI', domain: 'marketing.ekodi.kr', section: 'services', group: 'business' },
    ...
    { type: '에너지', name: 'Energy AI', domain: 'energy.ekodi.kr', section: 'services', group: 'worklife' },
