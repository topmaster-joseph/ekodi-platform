(() => {
  ...
  const SITE_AGENTS = [
    ...
    { domain:'ekodi.kr/admin', name:'Control Center', group:'Core & Access', role:'통합운영·권한·감사', manage:'admins', critical:true },
    { domain:'ekodi.kr/auth', name:'EKODI Auth', group:'Core & Access', role:'통합인증·계정·SSO', manage:'admins', critical:true },
    { domain:'ekodi.kr/ekodichurch', name:'에코디교회', group:'Community', role:'예배·사역·공동체 운영', manage:'services' },
    { domain:'ekodi.kr/community', name:'커뮤니티', group:'Community', role:'관계·그룹·참여·소통', manage:'community' },
    { domain:'ekodi.kr/social', name:'에코디 소셜', group:'Community', role:'소셜채널·미디어 연동', manage:'social' },
    { domain:'ekodi.kr/ekodibiz', name:'에코디비즈', group:'Business & Commerce', role:'사업·고객·서비스 운영', manage:'organization' },
    { domain:'ekodi.kr/ekodimall', name:'에코디몰', group:'Business & Commerce', role:'상품·판매·셀러 운영', manage:'services' },
    { domain:'ekodi.kr/marketing', name:'마케팅 AI', group:'Business & Commerce', role:'마케팅·자동화·Workspace', manage:'services' },
    { domain:'ekodi.kr/ekodibiz/trade', name:'에코디 트레이딩', group:'Business & Commerce', role:'무역·견적·계약·거래', manage:'organization' },
    { domain:'ekodi.kr/pay', name:'에코디 페이', group:'Business & Commerce', role:'결제·정산·귀속', manage:'finance', critical:true },
    { domain:'ekodi.kr/books', name:'에코디서점', group:'Knowledge & Content', role:'출판·배포·인세·콘텐츠', manage:'books' },
    { domain:'ekodi.kr/ekodilab', name:'에코디연구소', group:'Knowledge & Content', role:'연구·교육·프로젝트', manage:'services' },
    { domain:'ekodi.kr/mail', name:'에코디 메일', group:'Communication & Cloud', role:'메일 허브·조직 연결', manage:'communication' },
    { domain:'ekodi.kr/live', name:'에코디 라이브', group:'Communication & Cloud', role:'라이브·방송·송출', manage:'communication' },
    { domain:'ekodi.kr/cloud', name:'에코디 클라우드', group:'Communication & Cloud', role:'파일·문서·협업 자료', manage:'workspace' },
    { domain:'ekodi.kr/cgma', name:'청계면상인회', group:'Client Sites', role:'상권·회원·고객 운영', manage:'clients' },
    { domain:'ekodi.kr/jadam', name:'자담치킨 목포대점', group:'Client Sites', role:'점포·CRM·마케팅 운영', manage:'clients' },
    { domain:'ekodi.kr/pizzamaru', name:'피자마루 목포대점', group:'Client Sites', role:'점포·CRM·마케팅 운영', manage:'clients' },
    { domain:'ekodi.kr/yogurt', name:'요거트퍼플 목포대점', group:'Client Sites', role:'점포·CRM·마케팅 운영', manage:'clients' },
  ];
