(() => {
  ...
  section.innerHTML = `
    <div class="community-admin-head">
      <div>
        <p class="community-admin-kicker">EKODI COMMUNITY · SERVICE ADMIN</p>
        <h2>에코디커뮤니티 서비스 관리</h2>
    ...
    <div class="community-admin-grid">
      <article><small>PUBLIC PROVIDER</small><strong>EKODI Community</strong><span>사람 · 모임 · 참여 · 대화를 연결하는 외부 제공 주체</span></article>
      ...
      <article><small>BOOK CONTRACT</small><strong>EKODI Books</strong><span>책 메타데이터와 카탈로그는 Books의 명시적 서비스 계약으로 연결</span></article>
