...
export function mailUserPage(){
  ...
  const headers=secureHeaders('text/html; charset=utf-8');headers['content-security-policy']="default-src 'self'; style-src 'self' 'unsafe-inline' https://ekodi.kr; script-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net https://ekodi.kr; connect-src 'self' https://ekodi.kr https://renzehysxirjilvdxacv.supabase.co https://cdn.jsdelivr.net https://ekodi.kr; img-src 'self' data: https://lh3.googleusercontent.com; frame-ancestors 'none'; base-uri 'self'; form-action 'self'; object-src 'none'";headers['x-ekodi-route']='mail-hub';return new Response(html,{headers});
}
