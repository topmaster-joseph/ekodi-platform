...
test('canonical product URL stays marketplace while attributed URLs carry opaque ref codes', () => {
  assert.equal(makePublicUrl('https://ekodi.kr/ekodimall/', 'ABC123'), 'https://ekodi.kr/ekodimall/p/ABC123');
  assert.equal(makeAttributedUrl('https://ekodi.kr/ekodimall/', 'ABC123', 'sl_OPAQUE'), 'https://ekodi.kr/ekodimall/p/ABC123?ref=sl_OPAQUE');
});
