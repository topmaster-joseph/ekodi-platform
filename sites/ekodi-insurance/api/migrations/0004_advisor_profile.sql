...
CREATE TABLE IF NOT EXISTS insurance_advisor_profiles (
  ...
  role_label TEXT NOT NULL DEFAULT '원더 스마트플래너',
  ...
  wonder_official_url TEXT NOT NULL DEFAULT 'https://ntc.lotteins.co.kr/landing.do',
  direct_design_url TEXT NOT NULL DEFAULT '',
