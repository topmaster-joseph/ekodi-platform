...
const loginUrl=()=>{const target=new URL(config.authUrl||'https://ekodi.kr/auth/?site=delivery');target.searchParams.set('site','delivery');target.searchParams.set('return_to',cleanReturnUrl());return target.href;};
