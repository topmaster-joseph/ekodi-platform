(() => {
  ...
  const FEATURES={
    ...
    confirmations:{label:'지급·수령 확인',icon:'✓',styles:['confirmation-admin.css'],scripts:['confirmation-admin.js'],real:'[data-section="confirmations"]',hashes:['#confirmations'],insert:'after-aiops'},
    aimembers: {
      label: 'AI 회원운영', icon: '◈',
      styles: ['ai-ops-admin.css'],
      scripts: ['ai-ops-admin.js'],
    ...
    social: { label:'채널·자동게시', icon:'S', styles:['social-admin.css'], scripts:['social-admin.js'], real:'[data-section="social"]', hashes:['#social'] },
