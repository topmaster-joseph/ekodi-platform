...
export default {
  async fetch(request,env){
    ...
    if(request.method==='OPTIONS'){
      ...
      const headers=new Headers({'access-control-allow-methods':'GET,POST,DELETE,OPTIONS','access-control-allow-headers':'authorization,content-type','access-control-max-age':'86400','cache-control':'no-store','vary':'Origin'});
