...
function pgmAdminPage(request){const source=new URL(request.url);if(!/^\/pgm\/admin\/?$/i.test(source.pathname))return null;return injectEkodiShell(workspaceAdminPage(),'space','admin');}
